...
@interface  MJRefreshBaseView()
{
    ...
    __weak ECircleLoadingView *_activityView;
    BOOL _endingRefresh;
}
@end
...
- (ECircleLoadingView *)activityView
{
    if (!_activityView) {
        ECircleLoadingView *activityView = [[ECircleLoadingView alloc] initWithFrame:CGRectMake(0,0,20,20)];
        activityView.autoresizingMask = self.arrowImage.autoresizingMask;
        [self addSubview:_activityView = activityView];
    }
    return _activityView;
